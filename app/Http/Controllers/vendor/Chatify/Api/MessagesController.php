...
class MessagesController extends Controller
{
    ...
    public function getContacts(Request $request)
    {
        ...
        ->select('users.id','users.name','users.last_name','users.phone','users.image','users.role','pharmacys.name as pharmacy_name', 'users.pharmacy_id',DB::raw('sum(case when ch_messages.to_id='.Auth::user()->id.' and ch_messages.seen=0 then 1 else 0 end) as count_noread'), DB::raw('case when active_status is null or active_status < now() - interval 10 minute then 0 else 1 end as active_status'),DB::raw('MAX(ch_messages.created_at) max_created_at'))
