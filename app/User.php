...
class User extends Authenticatable implements OAuthenticatable
{
    ...
    /**
     * Pushes the stored expiry of the current API token 7 days out.
     * Passport 13 wraps the token row, so the row is updated directly.
     */
    public function extendTokenExpiry(): void
    {
        $token = $this->token();
    ...
    public function get_unread_news() {
        ...
        $res = ($news-$news_read);
        Redis::setex(request()->getHttpHost().':get_unread_news:'.$this->id, 300, $res);
        return (int)$res;
    }
    ...
    public function get_pharmacy_route() {
        ...
        $res=$res->first()->count;
        Redis::setex(request()->getHttpHost().':get_pharmacy_route', 120, $res);
        return (int)$res;
    }
    ...
    public function pharmacy_name() {
        ...
        Redis::setex(request()->getHttpHost().':pharmacy_name:'.$this->pharmacy_id, 600, $res);
        return $res;
    }
    ...
    public function pharmacy_balance() {
        ...
        Redis::setex(request()->getHttpHost().':pharmacy_balance:'.$this->pharmacy_id, 120, $res);
        return $res;
    }
    ...
    public function pharmacy_balance_ban() {
        ...
        Redis::setex(request()->getHttpHost().':pharmacy_balance_ban:'.$this->pharmacy_id, 120, $res);
        return $res;
    }
    ...
    public function income_today() {
        ...
        Redis::setex(request()->getHttpHost().':income_today', 300, $res);
        return number_format($res ?? 0,2);
    }
    ...
    public function copay_cash_today() {
        ...
        Redis::setex(request()->getHttpHost().':copay_cash_today', 300, $res);
        return number_format($res ?? 0,2);
    }
    ...
    public function copay_app_today() {
        ...
        Redis::setex(request()->getHttpHost().':copay_app_today', 300, $res);
        return number_format($res ?? 0,2);
    }
    ...
    public function notification_count() {
        ...
        Redis::setex(request()->getHttpHost().':notification_count:'.$this->id, 300, $res);
        return $res;
    }
