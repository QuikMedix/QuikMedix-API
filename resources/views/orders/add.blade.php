                                           ...
                                           <div class="row">
                                            ...
                                            <div style="float: right;">  
                                                <div class="form-check form-switch form-switch-md mr-4" dir="ltr">
                                                    <input type="checkbox" class="form-check-input" id="swith_family_id">
													<label class="form-check-label" for="swith_family_id" style="padding: 3px;">Family</label>
                                                </div>                                               
											</div>
											</div>
											<div class="col-12" style="margin-bottom: 20px;">
											    <select id="family_id" name="family_id" class="form-control" style="display:none;">
