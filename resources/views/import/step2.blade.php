 ...
 <!-- start page title -->
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <h5 style="background: #c90016;color: #ffffff;padding: 5px;text-align: center;">Order Data</h5>
                                        </div>
                                    </div>									
                                    @if($alert!='') 
                        ...
                        <div class="col-4">
                            <div class="card">
                                <div class="card-body">
                                    <h5 style="background: #c90016;color: #ffffff;padding: 5px;text-align: center;">Patient Profile</h5>
