...
<h2>Patient Card: XXXX{{substr($payment_account->card,-4)}}</h2>
<form method="POST">
  @csrf 
  <input type="hidden" name="pay" value="1">
  <button class="buy"><i class="material-icons">payment</i> {{round($order->copay*1.04,2)}} $ PAY CO-PAY</button>
</form>
@endif
<h2 style="margin-top:20px;">Add New Patient Card</h2>
<div class="container">
  <div class="col1">
    <div class="card">
      <div class="front">
