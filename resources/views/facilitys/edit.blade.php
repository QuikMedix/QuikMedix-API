                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
									<div class="row">
                                        <div class="col-12">
                                            <h5 style="background: #7a6fbe;color: #ffffff;padding: 5px;text-align: center;">Edit Order</h5> 
                                        </div>
                                    </div>									
                                        ...
                                        <div class="row">
                                            <div class="col-5">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div id="facilitys-b">
                                                                <select id="facilitys" placeholder="Facility..." name="facility">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <select class="form-control" @if(!(Auth::user()->role=="superadmin" || Auth::user()->role=="admin") && $order->statuse_id!=1){{"disabled"}}@endif placeholder="Select Status..." name="statuse">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <select class="form-control" placeholder="Select Driver..." name="driver" @if($order->type_driver==2) style="display:none;" @endif @if(Auth::user()->role=="medic") disabled @endif>
                                                            ...
                                                            <select class="form-control" placeholder="Select Driver..." name="driver2" @if($order->type_driver==1) style="display:none;" @endif>
                                                                <option value="">Select Driver...</option>
                                                        ...
                                                        <div class="col-sm-4" style="margin-bottom: 20px;">
                                                                ...
                                                                <input type="number" min="1" max="10" name="count_bags" class="form-control" value="{{ $order->count_bags }}">
                                                        </div>
                                                        <div class="col-sm-4" style="margin-bottom: 20px;">
                                                            <small>Total Co-pay ($)</small>
                                                            <input type="number" min="0" step="0.01" class="form-control" name="copay" value="{{ $order->copay }}" placeholder="Co-pay">
                                                            <div style="padding: 5px 20px;" class="paidph"> 
                                                                <input class="form-check-input" type="checkbox" id="formCheck2" value="1" name="copay_paid_pharm" @if($order->statuse_copay=='6'){{'checked disabled'}}@endif>
                                                                <label class="form-check-label" for="formCheck2">Paid at the pharmacy</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4 mt-4" style="margin-bottom: 20px;"> 
                                                            <div style="float: right;">
                                                                <div class="form-check form-switch form-switch-md" dir="ltr">  
                                                                    <label class="form-check-label" style="float: left;margin: 0 5px;">Fridge</label>
                                                                    <input type="checkbox" id="switch6" switch="primary" value="1" name="fridge" id="Fridge" {{ ($order->fridge>0)?'checked':'' }} />
                                                        ...
                                                        <div class="col-6 mt-4">                                         
                                                            <div style="float: right;">
                                                                <div class="form-check form-switch form-switch-md" dir="ltr">                                                       
                                                                    ...
                                                                    <input type="checkbox" id="swith_time_id" switch="primary" value="1" name="swith_time_id" id="swith_time_id" @if(empty($order->delivery_time_range) || $order->delivery_time_range=='9:00 AM;12:00 AM') checked @endif />
                                            ...
                                            <div class="col-7">
                                                ...
                                                <div class="row">  
                                                    ...
                                                    <div class="col-12 mt-3 recipient_blocks">
                                                        @foreach($additional_recipients as $key=>$additional_recipient)
                                                        <div class="card recipient_block">
                                                            <p class="card-header">Recipient #<span class="number">{{$key+1}}</span> - <span class="name">{{$additional_recipient->family_name}} {{$additional_recipient->family_phone}} ({{$additional_recipient->family_type}})</span> <span class="badge rounded-pill bg-dark text-light recipient_delete" style="float: right;cursor:pointer;">Delete</span></p>
                                                            <div class="card-body">   
                                                                <div class="col-sm-12 rx-list">
                                                                    ...
                                                                    @endphp
                                                                    @foreach($rxs as $k=>$rx)
                                                                    @if($additional_recipient->id===$rx->rx_recipient)
                                                                    <div class="rx-row col-sm-12 row rx-items">
                                                                        <div class="col-sm-3 rx-field">
                                                                            <small>RX#</small>
                                                                            <input type="text" maxlength="256" placeholder="" value="{{explode('-',$rx->rx_id)[0]}}" name="rx_id[]" class="form-control">
                                                                        </div>
                                                                        <div class="col-sm-2 rx-field">
                                                                            <small>Rf#</small>
                                                                            <input type="text" maxlength="20" placeholder="" value="@if(count(explode('-',$rx->rx_id))>1){{explode('-',$rx->rx_id)[1]}}@endif" name="rf_id[]" class="form-control">
                                                                        </div>
                                                                        <div class="col-sm-2 rx-field">
                                                                            <small>Qty</small>
                                                                            <input type="number" min="1" value="{{$rx->rx_count}}" name="rx_count[]" class="form-control">
                                                                        </div>
                                                                        <div class="col-sm-2 rx-field">
                                                                            <small>Co-pay</small>
                                                                            <input type="number" min="0" step="0.01" placeholder="" value="{{$rx->rx_copay}}" name="rx_copay[]" class="form-control">
                                                                        </div>
                                                                        <input type="hidden" name="rx_recipient[]" value="{{$rx->rx_recipient}}">
                                                                        <div class="col-sm-3 rx-field">
                                                                            <small>Date</small>
                                                                            <input type="date" placeholder="Date" value="{{$rx->rx_date}}" name="rx_date[]" class="form-control">
                                                                        </div>
                                                                        @if($kk>0)
                                                                        <div class="rx-field" style="position: absolute;right: 3px;top: 0px;"><i class="fas fa-eye-slash remove-rx"></i></div>
                                                                        @endif
                                                                    </div>
                                                                    @php
                                                                    $kk+=1;
                                                                ...
                                                                <div class="col-sm-12"  style="margin: 24px 0">
                                                                    <button type="button" data-id="{{$additional_recipient->id}}" class="btn btn-secondary btn-sm waves-effect add_rx2">Add RX <i class="fas fa-plus-circle" style="font-size:12px;"></i> </button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        @endforeach
