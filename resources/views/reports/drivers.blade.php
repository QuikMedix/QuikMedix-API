                        ...
                        <div class="card">
                            <div class="card-body">                                
                                <div class="rep-menu">  
                                    ...
                                    <a href="/reports/drivers" style="background: #7a6fbe;color: #ffffff !important;"> <i class="ti-truck"></i> Drivers </a>
                        ...
                        <div class="col-xl-9">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-4 mb-4">Total: <mark>XXX</mark>  Active: <mark>XXX</mark></h4> 
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="card">
                                                    <div class="card-header">
                                                    <i class="ti-location-pin"></i> New York
                                                    </div>
                                                    <div class="card-body">
                                                        <blockquote class="card-blockquote mb-0">
                                                            <h4>Customers: <mark>XXX</mark></h4>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="card">
                                                    <div class="card-header">
                                                    <i class="ti-location-pin"></i> Queens
                                                    </div>
                                                    <div class="card-body">
                                                        <blockquote class="card-blockquote mb-0">
                                                            <h4>Customers: <mark>XXX</mark></h4>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="card">
                                                    <div class="card-header">
                                                    <i class="ti-location-pin"></i> Manhattan
                                                    </div>
                                                    <div class="card-body">
                                                        <blockquote class="card-blockquote mb-0">
                                                            <h4>Customers: <mark>XXX</mark></h4>
