 ...
 <!-- start page title -->
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-sm-6">
                            <div class="card">
                                <div class="card-body"><h5 style="background: var(--qm-charcoal);color: #ffffff;padding: 5px;text-align: center;">Logo </h5>
                                ...
                                <div class="card-body"><h5 style="background: var(--qm-charcoal);color: #ffffff;padding: 5px;text-align: center;">Exterior</h5>
                                        <div class="form-group row" align="center">                                        
                                            <div class="col-sm-12" style="margin-bottom: 5px;">
                                                <div style="margin: 10px; min-height: 200px;">
                        ...
                        <div class="col-xl-4 col-sm-6">
                            <div class="card">
                                <div class="card-body" style="min-height: 430px;">
                                    <h5 style="background: var(--qm-charcoal);color: #ffffff;padding: 5px;text-align: center;">Tariff </h5><br>
                                    <div class="row"> 
                                ...
                                <div class="card-body">
                                    <h5 style="background: var(--qm-charcoal);color: #ffffff;padding: 5px;text-align: center;">Hours:</h5>
